    ...
    <div class="left_block">
			<div class="left_upper_block">
				...
				<form action="index_r.php" method="post">
					...
					<input class="left_block_input" name="all_tasks" type="button" value="All Tasks">
					<input class="left_block_input" name="today_tasks" type="button" value="Today">
					<input class="left_block_input" name="this_week_tasks" type="button" value="Week">
					<input class="left_block_input" name="history_tasks" type="button" value="History">
				</form>
			</div>
    </div>
		<div class="tasks_block">
			<div class="add_block">
				<div class="normal_add_block">
					<input class="add_name" name="name" type="text" value="">
					<input class="add_tag" name="tag" type="text" value="">
