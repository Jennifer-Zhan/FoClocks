...
$insQuery="SELECT * FROM onetime_task WHERE (LOWER(name) LIKE '%".$searchRequirements."%' OR LOWER(day) LIKE '%".$searchRequirements."%' OR LOWER(time) LIKE '%".$searchRequirements."%' OR LOWER(timeZone) LIKE '%".$searchRequirements."%' OR LOWER(tag) LIKE '%".$searchRequirements."%' OR LOWER(details) LIKE '%".$searchRequirements."%') AND (deletion=0)";
